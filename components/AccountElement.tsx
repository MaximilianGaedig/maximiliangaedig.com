...
const AccountElement: FC<Props> = ({
  ...
  <a href={href} target="_blank" rel="noopener noreferrer" className="text-center flex flex-col items-center max-w-1/4 p-5 gap-2 rounded-xl bg-zinc-900 drop-shadow-lg">
